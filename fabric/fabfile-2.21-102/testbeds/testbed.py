...
controller1 = 'root@10.84.29.102'
compute1 = 'ubuntu@10.84.14.47'
...
env.roledefs = {
    ...
    #'vgw': [host1], # Optional, Only to enable VGW.
                    # Only compute can support vgw
    #'tsn': [host1], # Optional, Only to enable TSN.
                    # Only compute can support TSN
    #'toragent': [host1], # Optional, Only to enable Tor Agent.
                         # Only compute can support Tor Agent
